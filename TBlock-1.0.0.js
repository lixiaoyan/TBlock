(function(window){
    ...
    TBlock.Game=function(parent){
        ...
        for(var i=0;i<count;i++){
            blocks[i]=new TBlock.Block(scene);
        }
                ...
                if(temp==frames){
                    ...
                    for(var j=0;j<max && j<hidden.length;j++){
                        ...
                        while(true){
                            ...
                            var flag=0;
                            for(var k=0;k<j;k++){
                                var rect=hidden[j].rect();
                                if(hidden[k].collision(rect[0],rect[1],rect[2],rect[3])){
                                    flag=1;
                                    break;
                                }
                            }
